...
// Insert All Entries and Test User information
  ...
  $description1 = "Kids can use this colorful 75-card deck to create a variety of interactive programming projects. They'll create their own version of Pong, Write an Interactive Story, Create a Virtual Pet, Play Hide and Seek, and more!
...
This collection of coding activity cards is perfect for sharing among small groups in homes and schools.";
  $sql-product1 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000001, 'Scratch Coding Cards', 'Scratch Team Mit', 01-08-2017, 0, 26.43, 0.85, $brief1, $description1)";
  ...
  $description2 = "";
  $sql-product2 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000002, 'The Very Hungry Caterpillar', 'Eric Carle', 30-10-1994, 0, 15.75, 0.95, $brief2, $description2)";
  ...
  $sql-product3 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000003, 'Harry and the Bucketful of Dinosaurs', 'Ian Whybrow', 13-07-2010, 0, 12.77, 0.95, $brief3, $description3)";
  ...
  $sql-product4 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000004, '12 Rules for Life', 'Jordan B.Peterson', 16-01-2018, 1, 24.00, 0.90, $brief4, $description4)";
  ...
  $description5 = "";
  $sql-product5 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000005, 'Homo Deus: A Brief History of Tomorrow', 'Yuval Noah Harari', 3-4-2017, 1, 18.01, 1, $brief5, $description5)";
...
Spellbinding, informative and moving, Stephen Fry's Mythos perfectly captures these stories for the modern age - in all their rich and deeply human relevance. ";
  $sql-product6 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000006, 'Mythos', 'Stephen Fry', 20-04-2017, 1, 25.90, 0.80, $brief6, $description6)";
  ...
  /* product 7 */
  $brief7 = "Harry Potter has never even heard of Hogwarts when the letters start dropping on the doormat at number four, Privet Drive. Addressed in green ink on yellowish parchment with a purple seal, they are swiftly confiscated by his grisly aunt and uncle. Then, on Harry's eleventh birthday, a great beetle-eyed giant of a man called Rubeus Hagrid bursts in with some astonishing news: Harry Potter is a wizard, and he has a place at Hogwarts School of Witchcraft and Wizardry. An incredible adventure is about to begin!";
  $description7 = "Harry Potter and the Philosopher’s Stone is also available as an Illustrated Kindle-in-Motion edition.";
  $sql-product7 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000007, 'Harry Potter and the Philosophers Stone', 'J.K. Rowling', 15-9-2015, 2, 22.99, 0.95, $brief7, $description7)";
  ...
  /* product 8 */
  $brief8 = "This popular paperback edition of the classic work of fantasy, with a striking new black cover based on JRR Tolkien's own design and featuring brand new reproductions of all his drawings and maps.";
  $description8 = "";
  $sql-product8 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000008, 'The Hobbit: International Edition', 'J.R.R. Tolkien', 13-11-1991, 2, 15.50, 1, $brief8, $description8)";
...
But if they fail…";
  $sql-product9 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000009, 'Agents of Mars', 'Glynn Stewart', 14-9-2018, 2, 16.99, 0.95, $brief9, $description9)";
...
As Carrie reads the secrets of her grandmother’s diaries and the enchantment of the house exerts itself, Carrie finds herself irresistibly drawn to him. But what of her husband? And is Leo really who he appears to be?";
  $sql-product10 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000010, 'The Italian House: The unmissable read of 2018', 'Teresa Crane', 14-03-2016, 3, 145.10, 0.75, $brief10, $description10)";
...
But as disconcerting as the tapes turn out to be, Sean prays that they will ultimately confirm the one thing he never dared question. Does destiny exist? And were his and Catherine’s love and life together always meant to be?";
  $sql-product11 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000011, 'Things We Never Said', 'Nick Alexander', 4-9-2018, 3, 22.24, 0.9, $brief11, $description11)";
...
Here we meet Carlton, a Ferrari-crashing bad boy known for Prince Harry-like antics; Colette, a celebrity girlfriend chased by fevered paparazzi; and the man Rachel has spent her entire life waiting to meet: her father. Meanwhile, Singapore's It Girl, Astrid Leong, is shocked to discover that there is a downside to having a newly minted tech billionaire husband. A romp through Asia's most exclusive clubs, auction houses and estates, China Rich Girlfriend brings us into the elite circles of Mainland China, introducing a captivating cast of characters and offering an inside glimpse at what it's like to be gloriously, crazily, China-rich.";
  $sql-product12 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000012, 'China Rich Girlfriend', 'Kevin Kwan', 27-4-2016, 3, 18.95, 1, $brief12, $description12)";
...
With her own heart breaking, Sara has five weddings before the end of the season to turn the business around and rescue her dreams. With the help of the locals and a little French courage, can she save Château Bellevue before the summer is over?";
  $sql-product13 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000013, 'The French for Always', 'Fiona Valpy', 23-4-2014, 4, 23.99, 0.8, $brief13, $description13)";
  if ($db->exec($sql-product13)){
    echo "product 13 info writes into database successfully";
  } else {
    echo "error in the processing of product 13 info writing into database";
  }
...
About Lonely Planet: Lonely Planet is a leading travel media company and the world’s number one travel guidebook brand, providing both inspiring and trustworthy information for every kind of traveler since 1973. Over the past four decades, we’ve printed over 145 million guidebooks and grown a dedicated, passionate global community of travelers. You’ll also find our content online, and in mobile apps, video, 14 languages, nine international magazines, armchair and lifestyle books, ebooks, and more.";
  $sql-product14 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000014, 'Lonely Planet Japan (Travel Guide)', 'Lonely Planet', 1-8-2017, 4, 21.75, 0.8, $brief14, $description14)";
  if ($db->exec($sql-product14)){
    echo "product 14 info writes into database successfully";
  } else {
    echo "error in the processing of product 14 info writing into database";
  }

  /* product 15 */
  $brief15 = "The utterly compelling and inspirational account of how two very different Australian writers tackle their demons walking the Camino de Santiago de Compostela, the legendary medieval pilgrimage across Spain. Two writers, barely acquainted, decide - pretty much on the spur of the moment - to seize the day and go on an 800-kilometre hike along the ancient Camino de Santiago pilgrim trail. With its history and legends of Templar Knights, Holy Grails and bandits, there's bound to be a book in it!";
...
";
  $sql-product15 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000015, 'The Year We Seized the Day: A true story of friendship and renewal on the Camino', 'Elizabeth Best', 1-1-2010, 4, 39.86, 0.95, $brief15, $description15)";
  if ($db->exec($sql-product15)){
    echo "product 15 info writes into database successfully";
  } else {
    echo "error in the processing of product 15 info writing into database";
  }
...
Torn between loyalty to her family and dread of what she might find, Cara digs into the early years of her parents’ troubled marriage, hunting down long-lost relatives who might help unravel the mystery. But the picture that begins to emerge is not at all the one she’d expected—because as she soon discovers, lies have a habit of multiplying . . .";
  $sql-product16 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000016, 'Postcards from a Stranger', 'Imogen Clark', 27-8-2018, 5, 20.81, 0.95, $brief16, $description16)";
  if ($db->exec($sql-product16)){
    echo "product 16 info writes into database successfully";
  } else {
    echo "error in the processing of product 16 info writing into database";
  }
...
Somebody thinks Rose has something they want and they’ll do anything to get it. Her house is broken into, someone else she knows is murdered, and suddenly, dying a virgin in the Fenton County jail isn’t her biggest worry after all.";
  $sql-product17 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000017, 'Twenty-Eight and a Half Wishes', 'Denise Grover Swank', 19-12-2013, 5, 23.25, 0.9, $brief17, $description17)";
  if ($db->exec($sql-product17)){
    echo "product 17 info writes into database successfully";
  } else {
    echo "error in the processing of product 17 info writing into database";
  }

  /* product 18 */
  $brief18 = "Dirty Headlines is a fantastic enemies-to-lovers office romance with a perfect, filthy as*hole hero that I wish I'd written myself. - Laurelin Paige, New York Times bestselling author. ";
...
But it's my heart at stake, and I fear I'll be raising the white flag.";
  $sql-product18 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000018, 'Dirty Headlines', 'LJ Shen', 20-4-2018, 5, 24.45, 1, $brief18, $description18)";
  if ($db->exec($sql-product18)){
    echo "product 18 info writes into database successfully";
  } else {
    echo "error in the processing of product 18 info writing into database";
  }
...
This is the story of wealth and power in the 21st century. It isn't too late to change it.";
  $sql-product19 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000019, 'Moneyland: Why Thieves And Crooks Now Rule The World And How To Take It Back', 'Oliver Bullough', 16-9-2018, 6, 38.99, 1, $brief19, $description19)";
  if ($db->exec($sql-product19)){
    echo "product 19 info writes into database successfully";
  } else {
    echo "error in the processing of product 19 info writing into database";
  }


  /* product 20 */
  $brief20 = "It's the biggest revolution you've never heard of, and it's hiding in plain sight. Over the past decade, Silicon Valley executives like Eric Schmidt and Elon Musk, special operators like the Navy SEALs and the Green Berets, and maverick scientists like Sasha Shulgin and Amy Cuddy have turned everything we thought we knew about high performance upside down. Instead of grit, better habits, or 10,000 hours, these trailblazers have found a surprising shortcut. They're harnessing rare and controversial states of consciousness to solve critical challenges and outperform the competition. ";
...
Today, this revolution is spreading to the mainstream, fueling a trillion-dollar underground economy and forcing us to rethink how we can all lead richer, more productive, more satisfying lives. Driven by four accelerating forces-psychology, neurobiology, technology, and pharmacology-we are gaining access to and insights about some of the most contested and misunderstood terrain in history. Stealing Fire is a provocative examination of what's actually possible; a guidebook for anyone who wants to radically upgrade their life.";
  $sql-product20 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000020, 'Stealing Fire: How Silicon Valley, the Navy SEALs, and Maverick Scientists Are Revolutionizing the Way We Live and Work', 'Steven Kotler', 18-12-2017, 6, 18.16, 1, $brief20, $description20)";
  if ($db->exec($sql-product20)){
    echo "product 20 info writes into database successfully";
  } else {
    echo "error in the processing of product 20 info writing into database";
  }


  /* product 21 */
  $brief21 = "A powerful meditation on the nature and dangers of ego, from the bestselling author of The Obstacle is the Way. It's wrecked the careers of promising young geniuses. It's evaporated great fortunes and run companies into the ground. It's made adversity unbearable and turned struggle into shame. Every great philosopher has warned against it, in our most lasting stories and countless works of art, in all culture and all ages. Its name? Ego, and it is the enemy - of ambition, of success and of resilience. ";
...
The result is an inspiring and timely reminder that humility and confidence are our greatest friends when confronting the challenges of a culture that tends to fan the flames of ego, a book full of themes and life lessons that will resonate, uplift and inspire.";
  $sql-product21 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000021, 'Ego is the Enemy: The Fight to Master Our Greatest Opponent', 'Ryan Holiday', 23-8-2017, 6, 16.80, 1, $brief21, $description21)";
  if ($db->exec($sql-product21)){
    echo "product 21 info writes into database successfully";
  } else {
    echo "error in the processing of product 21 info writing into database";
  }
...
The Traveling Man is the first book in a series of suspenseful crime thrillers. If you like edge-of-your-seat action, shady criminal worlds, and nail-biting plot twists, then you’ll love Michael King’s dizzying whodunnit. ";
  $sql-product22 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000022, 'The Traveling Man', 'Michael P. King', 14-12-2015, 7, 24.41, 1, $brief22, $description22)";
  if ($db->exec($sql-product22)){
    echo "product 22 info writes into database successfully";
  } else {
    echo "error in the processing of product 22 info writing into database";
  }
...
";
  $sql-product23 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000023, 'The Ex-Wife: A nail biting gripping psychological thriller', 'Jess Ryder', 27-4-2016, 7, 18.95, 1, $brief23, $description23)";
  if ($db->exec($sql-product23)){
    echo "product 23 info writes into database successfully";
  } else {
    echo "error in the processing of product 23 info writing into database";
  }
  ...
  $sql-product24 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000024, 'Crossing Savage: A Peter Savage Novel', 'Dave Edlund', 26-3-2014, 7, 18.09, 1, $brief24, $description24)";
  if ($db->exec($sql-product24)){
    echo "product 24 info writes into database successfully";
  } else {
    echo "error in the processing of product 24 info writing into database";
  }
...
It is a classic tale of power, money, corruption and greed with elements of tragedy and comedy.";
  $sql-product25 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000025, 'The Soong Dynasty', 'Sterling Seagrave', 18-12-2016, 8, 45.33, 0.95, $brief25, $description25)";
  if ($db->exec($sql-product25)){
    echo "product 25 info writes into database successfully";
  } else {
    echo "error in the processing of product 25 info writing into database";
  }
...
Here is the dramatic and often tragic story of the Taj and the men and women of the dynasty that created it.";
  $sql-product26 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000026, 'The Taj Mahal: A History', 'John David Cooper', 20-3-2017, 8, 38.95, 0.9, $brief26, $description26)";
  if ($db->exec($sql-product26)){
    echo "product 26 info writes into database successfully";
  } else {
    echo "error in the processing of product 26 info writing into database";
  }
  ...
  $sql-product27 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000027, 'James Cook: A Life From Beginning to End', 'Hourly History', 9-7-2015, 8, 39.87, 0.85, $brief27, $description27)";
  if ($db->exec($sql-product27)){
    echo "product 27 info writes into database successfully";
  } else {
    echo "error in the processing of product 27 info writing into database";
  }
  ...
  $brief28 = "";
  $description28 = "";
  $sql-product28 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000028, '', '', 27-4-2016, 3, 18.95, 1, $brief28, $description28)";
  if ($db->exec($sql-product28)){
    echo "product 28 info writes into database successfully";
  } else {
    echo "error in the processing of product 28 info writing into database";
  }

  /* product 29 */
  $brief29 = "";
  $description29 = "";
  $sql-product29 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000029, '', '', 27-4-2016, 3, 18.95, 1, $brief29, $description29)";
  if ($db->exec($sql-product29)){
    echo "product 29 info writes into database successfully";
  } else {
    echo "error in the processing of product 29 info writing into database";
  }

  /* product 30 */
  $brief30 = "";
  $description30 = "";
  $sql-product30 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000030, '', '', 27-4-2016, 3, 18.95, 1, $brief30, $description30)";
  if ($db->exec($sql-product30)){
    echo "product 30 info writes into database successfully";
  } else {
    echo "error in the processing of product 30 info writing into database";
  }

  /* product 31 */
  $brief31 = "";
  $description31 = "";
  $sql-product31 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000031, '', '', 27-4-2016, 3, 18.95, 1, $brief31, $description31)";
  if ($db->exec($sql-product31)){
    echo "product 31 info writes into database successfully";
  } else {
    echo "error in the processing of product 31 info writing into database";
  }

  /* product 32 */
  $brief32 = "";
  $description32 = "";
  $sql-product32 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000032, '', '', 27-4-2016, 3, 18.95, 1, $brief32, $description32)";
  if ($db->exec($sql-product32)){
    echo "product 32 info writes into database successfully";
  } else {
    echo "error in the processing of product 32 info writing into database";
  }
  ...
  $brief33 = "";
  $description33 = "";
  $sql-product33 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000033, '', '', 27-4-2016, 3, 18.95, 1, $brief33, $description33)";
  if ($db->exec($sql-product33)){
    echo "product 33 info writes into database successfully";
  } else {
    echo "error in the processing of product 33 info writing into database";
  }
  ...
  $brief34 = "";
  $description34 = "";
  $sql-product34 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000034, '', '', 27-4-2016, 3, 18.95, 1, $brief34, $description34)";
  if ($db->exec($sql-product34)){
    echo "product 34 info writes into database successfully";
  } else {
    echo "error in the processing of product 34 info writing into database";
  }
  ...
  $brief35 = "";
  $description35 = "";
  $sql-product35 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000035, '', '', 27-4-2016, 3, 18.95, 1, $brief35, $description35)";
  if ($db->exec($sql-product35)){
    echo "product 35 info writes into database successfully";
  } else {
    echo "error in the processing of product 35 info writing into database";
  }
  ...
  $brief36 = "";
  $description36 = "";
  $sql-product36 = "INSERT INTO product (id, title, author, date, category, price, discount, brief, description) VALUES (10000036, '', '', 27-4-2016, 3, 18.95, 1, $brief36, $description36)";
  if ($db->exec($sql-product36)){
    echo "product 36 info writes into database successfully";
  } else {
    echo "error in the processing of product 36 info writing into database";
  }
